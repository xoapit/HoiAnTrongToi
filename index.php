							...
							<div class="col-md-12">
								<div class="row thumbnail">
									...
									<div class="col-md-8 caption">
										<h3><a href="viewArticle.php?idArticle=<?php echo $article->getIdArticle(); ?>" style="text-decoration:none;"><?php echo $article->getTitle(); ?></a></h3><?php echo $article->getDescription(); ?>
										<hr />
